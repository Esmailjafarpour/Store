...
function BasicTextFields({hiddenNewProduct,editDataProduct}) {
    ...
    return (
        ...
        >
              <TextField 
                ...
                onBlur={()=>isValid()}
                value={newProduct.productName||editDataProduct.productName} 
                sx={styleTextField} 
              />
              ...
              <TextField
                ...
                onBlur={()=>isValid()}
                value={newProduct.price||editDataProduct.price}
                sx={styleTextField}
              />
              ...
              <TextField
                ...
                onChange={(e)=> (setNewProduct({...newProduct,[e.target.name]:Number(e.target.value)}),isValid())}
                onBlur={()=>isValid()}
                value={newProduct.rating||editDataProduct.rating}
                sx={styleTextField}
              />
              ...
              <TextField
                ...
                onChange={(e)=> (setNewProduct({...newProduct,[e.target.name]:Number(e.target.value)}),isValid())}
                onBlur={()=>isValid()}
                value={newProduct.quantityInStock||editDataProduct.quantityInStock}
                sx={styleTextField}
              />
              ...
              <TextField
                ...
                onChange={(e)=> (setNewProduct({...newProduct,[e.target.name]:Number(e.target.value)}),isValid())}
                onBlur={()=>isValid()}
                value={newProduct.discount||editDataProduct.discount}
                sx={styleTextField}
              />
              <Button
                  variant="contained"
