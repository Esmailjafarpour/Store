    ...
    if (state.password) {
      if (!validPasswordRegex.test(state.password)) {
        errorsData.password.push(
          "Password should be 6 to 15 charecters long with at least one uppercase letter,one lowercase letter and on digit"
        );
      }
    }
        ...
        <div className="card shadow my-2 bg-dark px-2">
          ...
          <div className="card-body">
            ...
            <div className="row mb-3">
              <label htmlFor="Email" className="col-lg-2 text-light py-1">
                Email
              </label>
            ...
            {/* Password */}
            <div className="row mb-3">
              <label htmlFor="Password" className="col-lg-2 text-light py-1">
                Password
              </label>
              <div className="col-lg-10">
                <input
            ...
            {/* FullName */}
            <div className="row mb-3">
              <label htmlFor="FullName" className="col-lg-2 text-light py-1">
                FullName
              </label>
              <div className="col-lg-10">
                <input
            ...
            {/* DateOfBrith */}
            <div className="row mb-3">
              <label htmlFor="DateOfBrith" className="col-lg-3 text-light py-1">
                Date Of Brith
              </label>
              <div className="col-lg-9">
                ...
                />
                <div className="text-warning">
                  {dirty["dateOfBrith"] && errors["dateOfBrith"][0]
                    ? errors["dateOfBrith"]
                    : ""}
                </div>
              </div>
            ...
            {/* Gender */}
            <div className="row mb-3">
              <label htmlFor="" className="col-lg-2 text-light py-1">
                Gender
              </label>
              <div className="col-lg-8 d-flex justify-content-around ">
                <div className="form-check">
                  ...
                  <label
                    htmlFor="male"
                    className="form-check-inline mb-1 text-light"
                  >
                    Male
                  </label>
                </div>
            ...
            {/* country */}
            <div className="row mb-3">
              <label htmlFor="Country" className="col-lg-2 text-light py-1">
                Country
              </label>
              <div className="col-lg-10">
                <select
            ...
            <div className="row mb-3 text-center">
              <label htmlFor="" className="col-lg-4 text-light py-1">
